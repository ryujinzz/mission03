(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function r(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=r(s);fetch(s.href,i)}})();new Swiper(".swiper",{loop:!0,speed:1e3,autoplay:{delay:500},centeredSlides:!0,slidesPerView:"auto",slideToClickedSlide:!0,effect:"coverflow",coverflowEffect:{rotate:0,depth:150,slideShadows:!1,stretch:100},breakpoints:{640:{slidesPerView:2},900:{slidesPerView:4}},observer:!0,observeParents:!0});function a(e,t=document){if(typeof e!="string")throw new Error("getNode 함수의 인수는 문자 타입 이어야 합니다.");return t.nodeType!==document.DOCUMENT_NODE&&(t=document.querySelector(t)),t.querySelector(e)}function p(e){return Object.prototype.toString.call(e).slice(8,-1).toLowerCase()}const g=e=>p(e)==="object",_=e=>p(e)==="number";function C(e,t){typeof e=="string"&&(e=a(e)),e.insertAdjacentHTML("beforeend",t)}function w({id:e,name:t="누구에게 보낼 건지 미입력",email:r="내용을 입력하지 않음"}){return`
  <article class="swiper-slide user-card" data-index="user-${e}">
  <h2 class="user-name">${t}</h2>
  <div class="user-resouce-info">
    <div>
      <a class="user-email" href="mailto:${r}">${r}</a>
    </div>
  </div>
  <button class="delete">삭제</button>
</article>
  `}function O(e,t){C(e,w(t))}function v(e=100,t="알 수 없는 오류가 발생했습니다"){return`
  <figure class="empty-user-card">
    <svg width="${e}" height="${e}" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </figure>`}function E(e){C(e,v())}function h(e){if(typeof e=="string"&&(e=a(e)),e.nodeName==="INPUT"||e.nodeName==="TEXTAREA"){e.value="";return}e.textContent=""}a(".first");a(".second");const u={shouldReject:!1,timeout:1e3,data:"success",errorMessage:"알 수 없는 오류 발생"};function b(e){let t={...u};_(e)&&(t.timeout=e),g(e)&&(t={...u,...e});const{shouldReject:r,timeout:n,data:s,errorMessage:i}=t;return new Promise((l,y)=>{setTimeout(()=>{r?y("실패"):l("아싸 성공")},n)})}b(!0).then(e=>{}).catch(e=>{});async function F(e){return e}F("이슬기나");const f={method:"GET",body:null,headers:{"Content-Type":"application/json","Access-Control-Allow-Origin":"*"}},o=async e=>{const{url:t,...r}={...f,...e,headers:{...f.headers,...e.headers}},n=await fetch(t,r);return n.ok&&(n.data=await n.json()),n};o.get=(e,t)=>o({url:e,...t});o.post=(e,t,r)=>o({method:"POST",url:e,body:JSON.stringify(t),...r});o.delete=(e,t)=>o({method:"DELETE",url:e,...t});o.put=(e,t,r)=>o({method:"PUT",url:e,body:JSON.stringify(t),...r});const m="http://localhost:3000/test",c=a(".swiper-wrapper"),d=async()=>{try{(await o.get("/server/data/data.json")).data.forEach(r=>O(c,r))}catch{E(c)}};d();function L(e){const t=e.target.closest("button"),r=e.target.closest("article");if(!r||!t)return;const n=r.dataset.index.slice(5);o.delete(`${m}/${n}`).then(()=>{h(c),d()})}c.addEventListener("click",L);const A=a(".create"),x=a(".cancel"),S=a(".done");function U(){gsap.to(".pop",{autoAlpha:1})}function D(e){e.stopPropagation(),gsap.to(".pop",{autoAlpha:0})}function N(e){e.preventDefault();const t=a("#nameField").value,r=a("#emailField").value,n={name:t,email:r};o.post(m,n).then(()=>{h(c),d(),gsap.to(".pop",{autoAlpha:0})})}A.addEventListener("click",U);x.addEventListener("click",D);S.addEventListener("click",N);
